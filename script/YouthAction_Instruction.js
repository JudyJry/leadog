...
export default class YouthAction_Instruction extends Action.ActionPage {
    constructor(manager) {
        ...
        this.children = {
            ...
            "logo": new Youth_Instruction_LogoVideo(this.manager, this)
        }
    }
}
class Youth_Instruction_LogoVideo extends Action.LogoVideo {
    constructor(manager, action) {
        super(manager, action);
        this.name = "Youth_Instruction_LogoVideo";
        this.onEnd = function () {
...
class Youth_Instruction_UI_Stage1 extends Action.ActionUI {
    constructor(manager, action) {
        ...
        this.draw = function () {
            ...
            this.action.children.line = new Action.ActionLine(manager, action,
                (s) => { });
